...
setLoading(false)
  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center min-h-screen py-2'>
        ...
        <Link href={'/signup'} style={{background:'white',color:'black',padding:3}} className='rounded'>Sign Up</Link>
        <Link href={'/emailenter'} style={{marginLeft:'-23',textDecoration:'underline',padding:3}} className='rounded'>Forgot Password ?</Link>
        </div>
        </>
  )
}
